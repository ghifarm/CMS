      ...
      <div
        ...
        <div v-if="isLoggedIn" class="profile container">
          <div class="profile-details ml-2">
            <div class="row">
              <!-- <div>
                <img v-if="profileImg" src="..\src\assets\logo.png" alt="profileImg">
                <i v-else class="bx bxs-user-rectangle"></i>
              </div> -->
              <img src="profileLogo.png" alt="profileImg">
              <div class="name_job">
                <div class="name">
                  {{ nameUser }}
                </div>
          ...
          <a href=""><i v-if="isExitButton" class="bx bx-log-out" id="log_out" @click.stop="logout" /></a>
        </div>
      </div>
    </div>
  </div>
